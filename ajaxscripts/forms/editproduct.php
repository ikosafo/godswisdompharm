...
<form autocomplete="off">
  ...
  <div class="row">
    ...
    <div class="mb-1 col-md-4">
      ...
      <input type="text" id="stockthreshold" onkeypress="return isNumber(event)" value="<?php echo $resdetails['stockthreshold']; ?>" class="form-control" placeholder="Low stock threshold" />
    </div>
  </div>
  ...
  <div class="row">
    <div class="mb-1 col-md-4">
      ...
      <input list="suppliers" id="supplier" class="form-control" placeholder="Enter or select a supplier" value="<?php echo $resdetails['supplier']; ?>" />
    ...
    <div class="mb-1 col-md-4">
      ...
      <input type="text" id="expirydate" class="form-control" placeholder="Expiry Date" value="<?php echo $resdetails['expirydate']; ?>" />
    </div>
    <div class="mb-1 col-md-4">
      <label class="form-label" for="variations">Variations</label>
      <input type="text" id="variations" class="form-control" placeholder="Specify Variations" value="<?php echo $resdetails['variations']; ?>" />
    </div>
    <div class="mb-1 col-md-4">
      <label class="form-label" for="sellingprice">Selling Price </label>
      <input type="text" id="sellingprice" oninput="updateReadOnlyBox()" value="<?php echo $resdetails['sellingprice']; ?>" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Selling Price" />
    </div>
    <div class="mb-1 col-md-4">
      <label class="form-label" for="costprice">Cost Price</label>
      <input type="text" id="costprice" readonly onkeypress="return isNumberKey(event)" value="<?php echo $resdetails['costprice']; ?>" class="form-control" placeholder="Cost Price" />
    </div>
  ...
  <div class="d-flex justify-content-between mt-2">
    ...
    <button id="editproductinfobtn" class="btn btn-primary waves-effect waves-float waves-light">
...
<script>
  ...
  //PRODUCT INFORMATION
  $("#editproductinfobtn").on("click", (function() {
